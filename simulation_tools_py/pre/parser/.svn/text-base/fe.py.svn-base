...
print "pure DMM", scipy.integrate.simps(puredmm[1], puredmm[0])
print "pure water", scipy.integrate.simps(purewater[1], purewater[0])
...
print "DMM in water"
for i in keys:
    print i, scipy.integrate.simps(dmm[i][1], dmm[i][0])
...
print "water in DMM"
for i in keys:
    print i, scipy.integrate.simps(water[i][1], water[i][0])

#specified data
#print dmm['090'][0]
#print dmm['090'][1]
#print scipy.integrate.simps(dmm['090'][1], dmm['090'][0])
