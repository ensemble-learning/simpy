...
os.environ['VASP_COMMAND'] = 'mpirun -np 8 /opt/sourcecoude/vasp5.4.4/vasp.5.4.4/bin/vasp_std'
...
for x in np.linspace(0.90, 1.10, 11):
    atoms.set_cell([cell[0]*x, cell[1]*x, cell[2]], scale_atoms=True)
